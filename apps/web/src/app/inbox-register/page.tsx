        ...
        <div className="w-full max-w-[400px] bg-white border border-gray-200 rounded-xl p-8 shadow-sm text-center">
          ...
          <button
            onClick={() => {
              ...
              router.push(redirect ? `/inbox-login?redirect=${encodeURIComponent(redirect)}` : "/inbox-login");
            }}
      ...
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 font-bold text-xl">
            ...
            <span className="text-black tracking-tight font-extrabold">Qwik Inbox</span>
          </Link>
          <h1 className="text-2xl font-bold mt-6 mb-2 text-black">Create your account</h1>
          <p className="text-sm text-gray-500">Connect and manage all your inboxes.</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-gray-500">
          Already have an account? <Link href="/inbox-login" className="text-black font-semibold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
