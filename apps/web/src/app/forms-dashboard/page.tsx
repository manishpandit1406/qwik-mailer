...
// FORM_TEMPLATES moved to templates/page.tsx
...
export default function FormsPage() {
  ...
  // groupedTemplates moved to templates/page.tsx
  ...
  // createForm moved to templates/page.tsx
    ...
    <div className="flex-1 overflow-y-auto p-4 lg:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          {!isViewer && (
            <Link href="/forms-dashboard/templates" className="btn-primary flex items-center gap-2">
        ...
        {loading ? (
          ...
          <div className="py-16 text-center bg-white border border-dashed border-gray-300 rounded-2xl">
            ...
            {!isViewer && (
              <Link href="/forms-dashboard/templates" className="btn-primary flex items-center gap-2 mx-auto">
