...
import { Inbox, Eye, EyeOff, ArrowRight, Shield, Fingerprint } from "lucide-react";
...
export default function InboxLoginPage() {
  ...
  useEffect(() => {
    if (localStorage.getItem("mf_access_token")) {
      ...
      const redirect = urlParams.get('redirect') || "/inbox-dashboard";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6 font-sans selection:bg-black selection:text-white">
      <div className="w-full max-w-[400px]">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-6 mb-2 text-black">Sign in to your inbox</h1>
